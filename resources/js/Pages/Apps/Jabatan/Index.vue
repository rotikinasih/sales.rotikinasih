                ...
                <div class="card-block table-border-style">
                    <div class="table-responsive">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" v-model="search" placeholder="search by Position Name..." @keyup="handleSearch">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr v-for="(jb, index) in jabatan.data" :key="index">
                                    ...
                                    <td>
                                        <a @click="editData(jb)" v-if="hasAnyPermission(['jabatan.edit'])"  class="label theme-bg3 text-white f-12" style="cursor:pointer"><i class="fa fa-pencil-alt"></i> Edit</a>
                                    </td>
                                </tr>
                                <!-- jika data kosong -->
