                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="user_detail1.nama_karyawan" :class="{'is-invalid': errors.nama_karyawan}" type="text" placeholder="Employee Name">
                                            </div>
                                            <div v-if="errors.nama_karyawan" class="alert alert-danger"> {{ errors.nama_karyawan }}</div>
                                            <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" v-model="user_detail3.no_hp" :class="{'is-invalid': errors.no_hp}" placeholder="HP Number">
                                            </div>
                                            <div v-if="errors.no_hp" class="alert alert-danger">{{ errors.no_hp }}</div>
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" v-model="user_detail3.no_wa" :class="{'is-invalid': errors.no_wa}" placeholder="WA Number">
                                            </div>
                                            <div v-if="errors.no_wa" class="alert alert-danger">{{ errors.no_wa }}</div>
                                            <div class="mb-3">
