                            ...
                            <tbody>
                                <tr v-for="(kar, index) in karyawan.data" :key="index">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <!-- <Link :href="`/apps/karyawan/${kar.id}/list-pelatihan`" class="label theme-bg10 text-white f-12 me-2" style="cursor:pointer; border-radius:10px" title="Pelatihan" data-toggle="tooltip-inner"><i class="fas fa-users-cog"></i></Link> -->
