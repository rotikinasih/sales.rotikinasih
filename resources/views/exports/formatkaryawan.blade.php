<table style="width: 100%">
    <thead>
        ...
        <tr>
            ...
            <th scope="col" style="font-weight: bold;background-color: lime; text-align: left; width: 10cm; border: 1px solid black;">Direktor, Div Head, Dept Head, Sect Head, Head, Staff, Non Staff</th>
        ...
        <tr>
            ...
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Informatika</th>
            ...
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">IT Programmer</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">2F</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">2022/01/22</th>
            ...
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">2022/03/22</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">12</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">2022/06/22</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Karanganyar</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Karanganyar</th>
