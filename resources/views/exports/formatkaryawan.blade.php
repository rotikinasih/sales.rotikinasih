<table style="width: 100%">
    <thead>
        <tr style="font-weight: bold;background-color: yellow;  border-collapse: collapse;">
            ...
            <th scope="col" style="background-color: yellow; text-align: center; width: 4cm; border: 1px solid black;">Nama Sekolah/Universitas</th>
            ...
            <th scope="col" style="background-color: orange; text-align: center; width: 4cm; border: 1px solid black;">Posisi Awal Diterima</th>
        ...
        <tr>
            ...
            <th scope="col" style="font-weight: bold;background-color: yellow; text-align: left; width: 5cm; border: 1px solid black;"></th>
            <th scope="col" style="font-weight: bold;background-color: yellow; text-align: left; width: 5cm; border: 1px solid black;"></th>
            <th scope="col" style="font-weight: bold;background-color: lime; text-align: left; width: 7cm; border: 1px solid black;">tanggal/bulan/tahun</th>
            ...
            <th scope="col" style="font-weight: bold;background-color: yellow; text-align: left; width: 7cm; border: 1px solid black;"></th>
            <th scope="col" style="font-weight: bold;background-color: yellow; text-align: left; width: 7cm; border: 1px solid black;"></th>
            <th scope="col" style="font-weight: bold;background-color: lime; text-align: left; width: 10cm; border: 1px solid black;">SD, SMP, SMA, D1, D2, D3, D4, S1, S2, S3</th>
            <th scope="col" style="font-weight: bold;background-color: yellow; text-align: left; width: 7cm; border: 1px solid black;"></th>
            <th scope="col" style="font-weight: bold;background-color: yellow; text-align: left; width: 7cm; border: 1px solid black;"></th>
            <th scope="col" style="font-weight: bold;background-color: yellow; text-align: left; width: 7cm; border: 1px solid black;"></th>
            <th scope="col" style="font-weight: bold;background-color: yellow; text-align: left; width: 7cm; border: 1px solid black;"></th>
            ...
            <th scope="col" style="font-weight: bold;background-color: lime; text-align: left; width: 7cm; border: 1px solid black;">Nama Entitas (Sesuaikan master data)</th>
            <th scope="col" style="font-weight: bold;background-color: lime; text-align: left; width: 7cm; border: 1px solid black;">Nama Divisi (Sesuaikan master data)</th>
            <th scope="col" style="font-weight: bold;background-color: lime; text-align: left; width: 7cm; border: 1px solid black;">Nama Jabatan (Sesuaikan master data)</th>
            <th scope="col" style="font-weight: bold;background-color: lime; text-align: left; width: 7cm; border: 1px solid black;">Nama Posisi (Sesuaikan master data)</th>
        ...
        <tr>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 1cm; border: 1px solid black;">1</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Ani Lestari</th>
            ...
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">22/01/1997</th>
            ...
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">3313100818970001</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">3313100818971000</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">57765</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Jl. Melati RT 06/ RW 05, Papahan, Tasikmadu, Karanganyar</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Jl. Melati RT 06/ RW 05, Papahan, Tasikmadu, Karanganyar</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">D3</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Universitas Sebelas Maret</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Hukum</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">ani@gmail.com</th>
            ...
            {{-- data diperusaan --}}
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">98.9898.988</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">PT RLA</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">DSS</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Staff</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Legal</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">2F</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">22/01/2022</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Kontrak</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Core</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">22/03/2022</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">12</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">22/06/2022</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Staff HR</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Karanganyar</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Karanganyar</th>
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">62327327362736</th>
            ...
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">Muamalat</th>
            ...
            <th scope="col" style="background-color: 	#00ffff; text-align: left; width: 7cm; border: 1px solid black;">HRD</th>
        </tr>
    </thead>
</table>
