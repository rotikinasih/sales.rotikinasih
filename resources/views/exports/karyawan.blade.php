<table style="width: 100%">
    <thead>
        <tr>
            <th><b>Database Karyawan RLA Group</b></th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="border: 1px solid black;">
                ...
                @elseif ($k->pendidikan == 3)
                    SMA
                @elseif ($k->pendidikan == 5)
                    D1
                @elseif ($k->pendidikan == 6)
                    D2
                @elseif ($k->pendidikan == 7)
                    D3
                @elseif ($k->pendidikan == 8)
                    S1
                @elseif ($k->pendidikan == 9)
                    S2
                @elseif ($k->pendidikan == 10)
                    S3
                @endif
            </td>
            ...
            <td style="border: 1px solid black;">
                ...
                @elseif ($k->status_keluarga == 1)
                    Kepala Keluarga
                @elseif ($k->status_keluarga == 2)
                    Istri 
                @elseif ($k->status_keluarga == 3)
                    Anak ke 1
                @elseif ($k->status_keluarga == 4)
                    Anak ke 2
                @elseif ($k->status_keluarga == 5)
                    Anak ke 4
                @elseif ($k->status_keluarga == 5)
                    Lainnya
                @endif
            ...
            <td style="border: 1px solid black;">
                ...
                @elseif ($k->jenis_sosmed == 1)
                    Instagram
                @elseif ($k->jenis_sosmed == 2)
                    Facebook 
                @elseif ($k->jenis_sosmed == 3)
                    Tiktok
                @elseif ($k->jenis_sosmed == 4)
                    Youtube
                @endif
            </td>
            ...
            <td style="border: 1px solid black;">
                ...
                @elseif ($k->status_kerja == 1)
                    Kontrak
                @elseif ($k->status_kerja == 2)
                    Tetap
                @elseif ($k->status_kerja == 3)
                    Training
                @endif
            </td>
            <td style="border: 1px solid black;">
