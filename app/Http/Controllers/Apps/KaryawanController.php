...
class KaryawanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $karyawan = Karyawan::create([
            ...
            'posisi_awal_diterima' => strtoupper($request->posisi_awal_diterima),
            'komposisi_peran' => $request->komposisi_peran,
            'kota_rekruitmen' => strtoupper($request->kota_rekruitmen),
            'kota_penugasan' => strtoupper($request->kota_penugasan),
    ...
    public function detail($id)
    {
        ...
        // Get related pelatihan data
        $pelatihan = Pelatihan::where('karyawan_id', $id)
            ->get();

         // Get related catatanPelanggaran data
        $catatanPelanggaran = CatatanPelanggaran::where('karyawan_id', $id)
            ->get();

        // Get related riwayatOrganisasi data
        $riwayatOrganisasi = RiwayatOrganisasi::with('perusahaan', 'jabatan','karyawan', 'divisi', 'posisi')
        ...
        return Inertia::render('Apps/Karyawan/Detail', [
            'karyawan' => $karyawan,
            'pelatihan' => $pelatihan,
